...
def main():
    ...
    KRR_alpha_lim = (0.00001,1.0)
    KRR_gamma_lim = (0.01,20.0)
    ...
    # Print final results
    print("Converged hyperparameters: alpha= %.12f, gamma= %.12f" %(best_hyperparams[0],best_hyperparams[1]))
    print("Minimum rmse: %.12f" %(best_rmse))
######################################################################################################
...
def KRR_function(hyperparams,X,y):
    ...
    print('alpha: %.12f . gamma: %.12f . rmse: %.12f' %(alpha_value,gamma_value,rmse)) # Uncomment to print intermediate results
    return rmse
######################################################################################################
main()
